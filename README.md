...
![folder](https://kazurayam.github.io/KS_PurgeHTMLReport/images/report-folder-contained-new-html.png)

The `test-suite-report.html` looked just fine. I found nothing wrong in the new HTML report.

![report](https://kazurayam.github.io/KS_PurgeHTMLReport/images/report-foler-contained-new-html.png)
